...
pub const MAX_PICKUP_RANGE: f64 = 5.0;
pub const MAX_MOUNT_RANGE: f64 = 5.0;
pub const MAX_TRADE_RANGE: f64 = 20.0;

pub const GRAVITY: f64 = 25.0;
pub const FRIC_GROUND: f64 = 0.15;
